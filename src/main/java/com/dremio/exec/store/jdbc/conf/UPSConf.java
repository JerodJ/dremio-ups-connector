...
@SourceType(value = "UPSARP", label = "UPS",uiConfig = "ups-layout.json")
public class UPSConf extends AbstractArpConf<UPSConf> {
  private static final String ARP_FILENAME = "arp/implementation/ups-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.ups.UPSDriver";
